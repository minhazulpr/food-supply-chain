...
<div class="container">
    <div class="py-5 text-center">
        <h2>FoodChain Checkout Form</h2>
        <p class="lead">Please Provide Below Information</p>
    </div>
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0 checkout-product-name"></h6>
                    </div>
                    <span class="text-muted checkout-product-price"></span>
                    <input type="hidden" value="{{ $pid }}" name="product_id">
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div style="margin-right: 10px">
                        <h6 class="my-0 mt-2">Quantity</h6>
                    </div>
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <input type="number" name="total_amount" readonly class="total-amount form-control w-50" value="">
                </li>
            </ul>
        </div>
